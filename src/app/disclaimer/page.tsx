...
export const metadata: Metadata = {
  title: "Disclaimer | Phone Mast Advice",
  description: "Disclaimer for The Phone Mast Advice Company Ltd — Reg. 13115582.",
    ...
    <>
      ...
      <section className="section-padding">
        <div className="container-max" style={{ maxWidth: "720px" }}>
          <h1 style={{ fontFamily: "var(--font-jakarta), system-ui, sans-serif", fontWeight: 800, fontSize: "clamp(1.75rem, 3vw, 2.5rem)", color: "#1a1a2e", marginBottom: "1.25rem" }}>Disclaimer</h1>
