...
export const metadata: Metadata = {
  title: "Phone Mast Sales — Sell Your Mast Lease",
    ...
    <>
      ...
      <section className="section-padding">
        <div className="container-max" style={{ maxWidth: "800px" }}>
          <h1 style={{ fontFamily: "var(--font-jakarta), system-ui, sans-serif", fontWeight: 800, fontSize: "clamp(1.75rem, 3vw, 2.5rem)", color: "#1a1a2e", marginBottom: "1.25rem" }}>Mast Sales</h1>
          <p style={{ fontSize: "1.125rem", color: "#374151", lineHeight: 1.7, marginBottom: "1.25rem" }}>Our specialist team provides expert mast sales advice for UK landlords and landowners with phone mast sites. We act exclusively for landlords — never for mobile phone operators.</p>
